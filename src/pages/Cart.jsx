          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1">
              <div className="glass-panel sticky top-24">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span
                      className={`font-semibold ${
                        total >= 500 ? "text-green-500" : "text-foreground"
                      }`}
                    >
                      {total >= 500 ? "Free" : "40"}
                    </span>
                ...
                <Link
                  to="/payment"
                  className="w-full block text-center py-4 gradient-primary text-primary-foreground
  rounded-lg hover:glow-on-hover animate-smooth font-semibold mb-4"
                >
                  Proceed to Checkout
                </Link>
                ...
                {authUser && (
                  <Link
                    to="/products"
                    className="w-full block text-center py-4 bg-secondary text-foreground rounded-lg
    animate-smooth font-semibold mb-4 border border-border hover:bg-accent"
                  >
                    Continue Shopping
                  </Link>
                )}
